defmodule Glitchtv.StreamService do
  @moduledoc false
  ...
  def handle_call(:stream_started, _from, state) do
    ...
    Phoenix.PubSub.broadcast(Glitchtv.PubSub, "stream_info:status", {:started, started})
  ...
  def handle_call(:stream_ended, _from, state) do
    ...
    Phoenix.PubSub.broadcast(Glitchtv.PubSub, "stream_info:status", :finished)
  ...
  def handle_info(:tick, state) do
    Phoenix.PubSub.broadcast(Glitchtv.PubSub, "stream_info:status", :tick)
    {:noreply, state}
  end
end
