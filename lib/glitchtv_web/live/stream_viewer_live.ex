defmodule GlitchtvWeb.StreamViewerLive do
  ...
  defp live_dropping(assigns) do
    ~H"""
    <p class="glitchtv-live-dropping-container">
      live
    </p>
    """
  end
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(Glitchtv.PubSub, "stream_info:status")
