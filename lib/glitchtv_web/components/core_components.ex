defmodule GlitchtvWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(GlitchtvWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(GlitchtvWeb.Gettext, "errors", msg, opts)
    # end
